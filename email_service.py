...
def send_simple_message(to, subject, body):
    return requests.post(
        "https://api.mailgun.net/v3/sandbox1396261616534394a2132b0c64eb5aa2.mailgun.org/messages",
        auth=("api", "d981167b858a71a285bd0064321b6371-2ac825a1-64b15e18"),
        data={"from": "Mailgun Sandbox <postmaster@sandbox1396261616534394a2132b0c64eb5aa2.mailgun.org>",
              "to": [to, "postmaster@sandbox1396261616534394a2132b0c64eb5aa2.mailgun.org"],
              "subject": subject,
              "html": body})
